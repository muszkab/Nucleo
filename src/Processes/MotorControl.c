...
#define MAX_OUTPUT	80.0f //Az inverz függvényben a maximális megengedhető kimenet FOXBORO-hoz
#define Zd			0.9f
#define Kc			8.78f
...
/**
  ...
  * A megadott tartományon a megadott időközökkel gerjeszti a motort és elküldi
